...
int main() {
    ...
    std::cout << std::hex << num << std::endl;  // hexidecimal
    std::cout << std::oct << num << std::endl;  // octet
    ...
    // resetting to DEFAULTS, not back to normal   
    std::cout << std::resetiosflags(std::ios::basefield);   // set integer base back to decimal
    std::cout << std::resetiosflags(std::ios::showbase);    // reset back to default
    std::cout << std::resetiosflags(std::ios::showpos);     // reset NOT show +
    std::cout << std::resetiosflags(std::ios::uppercase);   // not showing uppercase

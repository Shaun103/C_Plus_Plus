...
int main()
{
      Tours tours
        { "Tour Ticket Prices from Miami",
            {
                {
                    "Colombia", { // vector of cities in Columbia
                ...
                {
                    "Brazil", { // vector of cities in BRazil
                ...
                {
                    "Chile", { // vector of cities in Chile
                        { "Valdivia", 260000, 569.12 }, 
                        { "Santiago", 7040000, 520.00 }
                },
            },
                { "Argentina", { // vector of cities in Argentina
...
/******************************************************************************************************/ 
    ...
    std::cout << std::endl;
    std::cout 
                   << std::setw(field1_width) << std::left << "Country" 
